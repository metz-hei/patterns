...
2. Перевод между счетами внутри банка: черным цветом без знака.
...
![Платёжная страница. Подробности скрыты](./payment-page-without-details.png)

![Платёжная страница. Подробности](./payment-page-open-details.png)

Перевод в другой банк или другому контрагенту:

![Платёжная страница РБ. В другой банк](./transfer-to-another-bank-open.png)

Перевод из другого банка в ПСБ:
...
![Что делать дальше](./what-to-do-next-smb.png)
...
![Сбор обратной связи](./collecting-feedback-from-smb.png)

![Сбор обратной связи в РБ](./collecting-feedback-from-rb.png)
...
![Продающая страница](./sales-page-smb-1.png)

![Продающая страница в РБ](./selling-page-rb​-1.png)

![Продающая страница](./sales-page-smb-2.png)

![Продающая страница в РБ](./selling-page-rb​-2.png)

![Продающая страница](./sales-page-smb-3.png)

![Продающая страница в РБ](./selling-page-rb​-3.png)

![Продающая страница](./sales-page-smb-4.png)

![Продающая страница в РБ](./selling-page-rb​-4.png)

![Продающая страница](./sales-page-smb-5.png)
...
![Результирующая страница](./resulting-page-smb.png)

![Результирующая страница в РБ](./resulting-page-rb.png)
...
![500-я при загрузке страницы](./error-page-smb.png)

![500-я при загрузке страницы в РБ](./error-rb-1.png)
...
![500-я при отправке формы](./error-form-smb.png)
...
![Недостаточно прав](./not-enough-rights-smb.png)

![Недостаточно прав в РБ](./not-enough-rights-rb.png)
...
![Платёжная страница. Блокирующая ошибка](./block-error-smb.png)

![Платёжная страница. Блокирующая ошибка. РБ](./block-error-rb.png)
...
![Платёжная страница. Не блокирующая ошибка](./not-block-error-smb.png)

![Платёжная страница. Не блокирующая ошибка. РБ](./not-block-error-rb.png)
...
![Истечение сессии](./session-closed.png)

## Состояние «Предупреждение»

Подойдёт для вывода сообщения об операции, которая выполнена частично.

![Состояние «Предупреждение в СМБ»](./warning-smb.png)

![Состояние «Предупреждение» в РБ](./warning-rb.png)

## Состояние «Ожидание»

Подойдёт, если выполнения сценария растянуто во времени. Например, формирование отчёта или подготовка выписки.

![Состояние «Ожидание»](./expectation-smb.png)

![Состояние «Ожидание» в РБ](./expectation-rb.png)

## Состояние «Инфо»

Подойдёт, если необходимо о чём-то проинформировать пользователя. Например, для подключения некой услуги пользователю обязательно нужен подтвержденный адрес электронной почты.

Состояние «Инфо» не может быть концом сценария, а значит используется только в модальном окне.

![Состояние «Инфо»](./info-smb.png)
...
![Структура и размеры](./sctructure-smb.png)
...
![Структура и размеры](./paddings-smb.png)
