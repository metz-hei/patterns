...
[В Гитхабе](https://github.com/metz-hei/psb/issues). Заводите сюда любые задачи, которые посчитаете нужным. Формат заведения — произвольный.
...
Все задачи живут [на доске](https://github.com/users/metz-hei/projects/3/views/1):
