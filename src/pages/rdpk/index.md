...
В таблицах и списках, где суммы нужно сравнивать по правому краю, показываем копейки везде — даже если это ,00. Так данные легче сравнивать.
...
Обычный номер — +7 (999) 123-45-67, номер 8 800 — 8 800 333 25 50.
...
По ссылке сразу должно быть понятно, куда она ведёт. Не пишем «здесь», «тут», «по ссылке». В ссылку включаем предлоги.
