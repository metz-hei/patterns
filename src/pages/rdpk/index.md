...
Банк и наши пользователи — бизнес-партнёры, между которыми должны быть доверительные отношения. В интерфейсе мы говорим от имени команды банка и берём на себя действие и ответственность. Пишем в настоящем времени и сразу показываем пользу: мы делаем → вам доступно.
...
Пишется перед числом. Без пробелов.
...
Маркетинговое название склоняется и пишется без кавычек: …в банке ПСБ.
