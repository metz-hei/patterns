...
Вышли новые версии веб-витрин:

[Общий кит 0.210.0](/resources/showcases)

[СМБ 5.0.0](/resources/showcases)

[Продуктовые компоненты 0.34.0](/resources/showcases)
...
🔥 Научились локально разворачивать документацию по паттернам, витрины компонентов [iOS и Android](/resources/showcases/).
